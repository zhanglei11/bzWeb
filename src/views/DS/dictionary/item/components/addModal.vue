<template>
  ...
  >
    <a-form
      ...
      ref="formRef"
    >
      <a-form-item :label="$t('dictionary.字典项名称')" name="name">
        <a-input
          type="text"
          :allowClear="true"
      ...
      <a-form-item :label="$t('dictionary.字典项标识')" name="code">
        <a-input
          type="text"
          :allowClear="true"
      ...
      <a-form-item :label="$t('dictionary.字典项值')" name="value">
        <a-input
          type="text"
          :allowClear="true"
       ...
       <a-form-item :label="$t('dictionary.排序号')" name="sort">
        <a-input-number
          :allowClear="true"
      ...
      <a-form-item :label="$t('dictionary.描述')">
        <a-textarea
          :allowClear="true"
...
import { system_dict_item_add, system_dict_item_update } from "@/apis/dictionary";
